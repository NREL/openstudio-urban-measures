module OsLib_ModelGeneration
  ...
  def building_form_defaults(building_type)
    ...
    # DEER
    hash['Asm'] = { aspect_ratio: 1.5, wwr: 0.15, typical_story: 10.0 } # SmallOffice
    hash['ECC'] = { aspect_ratio: secondary_aspet_ratio.round(1), wwr: 0.33, typical_story: 13.0 } # SecondarySchool
    hash['EPr'] = { aspect_ratio: primary_aspet_ratio.round(1), wwr: 0.35, typical_story: 13.0 } # PrimarySchool
    hash['ERC'] = { aspect_ratio: primary_aspet_ratio.round(1), wwr: 0.35, typical_story: 13.0 } # PrimarySchool
    hash['ESe'] = { aspect_ratio: secondary_aspet_ratio.round(1), wwr: 0.33, typical_story: 13.0 } # SecondarySchool
    hash['EUn'] = { aspect_ratio: secondary_aspet_ratio.round(1), wwr: 0.33, typical_story: 13.0 } # SecondarySchool
    hash['Gro'] = { aspect_ratio: supermarket_aspet_ratio.round(1), wwr: supermarket_wwr.round(2), typical_story: 20.0 } # SuperMarket
    ...
    hash['OfS'] = { aspect_ratio: 1.5, wwr: 0.15, typical_story: 10.0 } # SmallOffice
    hash['OfL'] = { aspect_ratio: 1.5, wwr: 0.33, typical_story: 13.0 } # MediumOffice
    hash['RFF'] = { aspect_ratio: 1.0, wwr: 0.14, typical_story: 10.0 } # QuickServiceRestaurant
    hash['RSD'] = { aspect_ratio: 1.0, wwr: 0.18, typical_story: 10.0 } # FullServiceRestaurant
    hash['Rt3'] = { aspect_ratio: 1.28, wwr: 0.07, typical_story: 20.0 } # RetailStandalone
    hash['RtL'] = { aspect_ratio: 4.0, wwr: 0.11, typical_story: 17.0 } # RetailStripmall
    hash['RtS'] = { aspect_ratio: 4.0, wwr: 0.11, typical_story: 17.0 } # RetailStripmall
    hash['SCn'] = { aspect_ratio: 2.2, wwr: 0.71, typical_story: 28.0 } # Warehouse
    hash['SUn'] = { aspect_ratio: 2.2, wwr: 0.71, typical_story: 28.0 } # Warehouse
    hash['WRf'] = { aspect_ratio: 2.2, wwr: 0.71, typical_story: 28.0 } # Warehouse
  ...
  def get_space_types_from_building_type(building_type, template, whole_building = true)
    ...
    ## DEER Building Types
        ...
        hash['OfficeGeneral'] = { ratio: 0.23420560791639405, space_type_gen: true, default: false} 
        hash['Auditorium'] = { ratio: 0.7657943920836059, space_type_gen: true, default: false}
    elsif building_type == 'ECC'
        hash['OfficeGeneral'] = { ratio: 0.18110793826005125, space_type_gen: true, default: false} 
        hash['Dining'] = { ratio: 0.08751181020484886, space_type_gen: true, default: false}
        hash['Kitchen'] = { ratio: 0.01874853822219024, space_type_gen: true, default: false}
        hash['Shop'] = { ratio: 0.12495790639822747, space_type_gen: true, default: false}
        hash['CompRoomClassRm'] = { ratio: 0.031958475645035275, space_type_gen: true, default: false}
        hash['Classroom'] = { ratio: 0.555715331269647, space_type_gen: true, default: false}
    elsif building_type == 'EPr'
        hash['Dining'] = {ratio: 0.15016694215008278, space_type_gen: true, default: false}
        hash['Kitchen'] = {ratio: 0.07002764568085741, space_type_gen: true, default: false}
        hash['Gymnasium'] = {ratio: 0.14988591306351423, space_type_gen: true, default: false}
        hash['Classroom'] = {ratio: 0.6299194991055457, space_type_gen: true, default: false}
    elsif building_type == 'ERC'
        hash['Classroom'] = {ratio: 0.5, space_type_gen: true, default: false}
    elsif building_type == 'ESe'
        hash['Dining'] = {ratio: 0.1034060057593252, space_type_gen: true, default: false}
        hash['Kitchen'] = {ratio: 0.04828698398113825, space_type_gen: true, default: false}
        hash['Gymnasium'] = {ratio: 0.413804081147348, space_type_gen: true, default: false}
        hash['CompRoomClassRm'] = {ratio: 0.014172210453583061, space_type_gen: true, default: false}
        hash['Classroom'] = {ratio: 0.4203307186586055, space_type_gen: true, default: false}
    elsif building_type == 'EUn'
        hash['FacMaint'] = {ratio: 0.08001698153801826, space_type_gen: true, default: false}
        hash['Kitchen'] = {ratio: 0.010489637296669525, space_type_gen: true, default: false}
        hash['Dining'] = {ratio: 0.02401472601434893, space_type_gen: true, default: false}
        hash['CorridorStairway'] = {ratio: 0.029985490710594222, space_type_gen: true, default: false}
        hash['DormitoryRoom'] = {ratio: 0.1699177806933703, space_type_gen: true, default: false}
        hash['OfficeGeneral'] = {ratio: 0.34212313022290153, space_type_gen: true, default: false}
        hash['CompRoomClassRm'] = {ratio: 0.03801368113587793, space_type_gen: true, default: false}
        hash['Classroom'] = {ratio: 0.3054385723882191, space_type_gen: true, default: false}
    elsif building_type == 'Gro'
        hash['IndLoadDock'] = {ratio: 0.05702146690518771, space_type_gen: true, default: false}
        hash['RefWalkInFreeze'] = {ratio: 0.016245527728085876, space_type_gen: true, default: false}
        hash['RefWalkInCool'] = {ratio: 0.031194900649959525, space_type_gen: true, default: false}
        hash['RefFoodPrep'] = {ratio: 0.025341860785135752, space_type_gen: true, default: false}
        hash['OfficeGeneral'] = {ratio: 0.07000223613595714, space_type_gen: true, default: false}
        hash['GrocSales'] = {ratio: 0.800194007795674, space_type_gen: true, default: false}
    elsif building_type == 'Hsp'
        hash['Kitchen'] = {ratio: 0.007493225027371588, space_type_gen: true, default: false}
        hash['PatientRoom'] = {ratio: 0.379987381157853, space_type_gen: true, default: false}
        hash['HspSurgOutptLab'] = {ratio: 0.23161609359775268, space_type_gen: true, default: false}
        hash['OfficeGeneral'] = {ratio: 0.36341736181398854, space_type_gen: true, default: false}
        hash['Dining'] = {ratio: 0.01748593840303426, space_type_gen: true, default: false}
    elsif building_type == 'Htl'
        hash['Laundry'] = {ratio: 0.020541401273885367, space_type_gen: true, default: false}
        hash['HotelLobby'] = {ratio: 0.0410855014574112, space_type_gen: true, default: false}
        hash['GuestRmOcc'] = {ratio: 0.80275389742544, space_type_gen: true, default: false}
        hash['GuestRmCorrid'] = {ratio: 0.1010974466315608, space_type_gen: true, default: false}
        hash['Dining'] = {ratio: 0.00399734507259067, space_type_gen: true, default: false}
        hash['OfficeGeneral'] = {ratio: 0.02054140127388534, space_type_gen: true, default: false}
        hash['Kitchen'] = {ratio: 0.004991503432613257, space_type_gen: true, default: false}
        hash['BarCasino'] = {ratio: 0.004991503432613243, space_type_gen: true, default: false}    
    elsif building_type == 'MBT'
        hash['Dining'] = {ratio: 0.02999494094096515, space_type_gen: true, default: false}
        hash['OfficeOpen'] = {ratio: 0.26662674536074027, space_type_gen: true, default: false}
        hash['Laboratory'] = {ratio: 0.4533645307890388, space_type_gen: true, default: false}
        hash['CorridorStairway'] = {ratio: 0.20002475748042917, space_type_gen: true, default: false}
        hash['Kitchen'] = {ratio: 0.010000856453104221, space_type_gen: true, default: false}
        hash['Conference'] = {ratio: 0.01999408448786107, space_type_gen: true, default: false}
        hash['CompRoomData'] = {ratio: 0.01999408448786107, space_type_gen: true, default: false}
    elsif building_type == 'MFm'
        hash['ResBedroom'] = {ratio: 0.2673913043478259, space_type_gen: true, default: false}
        hash['Corridor'] = {ratio: 0.07246376811594203, space_type_gen: true, default: false}
        hash['ResLiving'] = {ratio: 0.32681159420289835, space_type_gen: true, default: false}
    elsif building_type == 'MLI'
        hash['Work'] = {ratio: 0.7999882526519707, space_type_gen: true, default: false}
        hash['StockRoom'] = {ratio: 0.20001174734802923, space_type_gen: true, default: false}
    elsif building_type == 'Mtl'
        hash['OfficeGeneral'] = {ratio: 0.019984532885127148, space_type_gen: true, default: false}
        hash['Laundry'] = {ratio: 0.015986026905709952, space_type_gen: true, default: false}
        hash['GuestRmOcc'] = {ratio: 0.31507427416611644, space_type_gen: true, default: false}
        hash['GuestRmCorrid'] = {ratio: 0.6489551660430464, space_type_gen: true, default: false}
     elsif building_type == 'Nrs'
        hash['PatientRoom'] = {ratio: 0.4446400185428118, space_type_gen: true, default: false}
        hash['OfficeGeneral'] = {ratio: 0.3499253907707089, space_type_gen: true, default: false}
        hash['Kitchen'] = {ratio: 0.044992130265084744, space_type_gen: true, default: false}
        hash['Dining'] = {ratio: 0.10496664890147298, space_type_gen: true, default: false}
        hash['CorridorStairway'] = {ratio: 0.055475811519921654, space_type_gen: true, default: false}
    elsif building_type == 'OfL'
        hash['OfficeSmall'] = {ratio: 0.3703703703703705, space_type_gen: true, default: false}
        hash['OfficeOpen'] = {ratio: 0.5296296296296297, space_type_gen: true, default: false}
        hash['MechElecRoom'] = {ratio: 0.058847736625514395, space_type_gen: true, default: false}
        hash['LobbyWaiting'] = {ratio: 0.04115226337448562, space_type_gen: true, default: false}
    elsif building_type == 'OfS'
        hash['OfficeSmall'] = {ratio: 0.6859422332863442, space_type_gen: true, default: false}
        hash['Hall'] = {ratio: 0.3140577667136559, space_type_gen: true, default: false}
    elsif building_type == 'RFF'
        hash['LobbyWaiting'] = {ratio: 0.1501423859786096, space_type_gen: true, default: false}
        hash['Restroom'] = {ratio: 0.05014794128392617, space_type_gen: true, default: false}
        hash['Kitchen'] = {ratio: 0.3999694708446566, space_type_gen: true, default: false}
        hash['Dining'] = {ratio: 0.39974020189280757, space_type_gen: true, default: false}
    elsif building_type == 'RSD'
        hash['Kitchen'] = {ratio: 0.28610883758164296, space_type_gen: true, default: false}
        hash['LobbyWaiting'] = {ratio: 0.14288247838362098, space_type_gen: true, default: false}
        hash['Restroom'] = {ratio: 0.03573791983878692, space_type_gen: true, default: false}
        hash['Dining'] = {ratio: 0.5352707641959492, space_type_gen: true, default: false}
    elsif building_type == 'Rt3'
        hash['RetailSales'] = {ratio: 1.0, space_type_gen: true, default: false}
    elsif building_type == 'RtL'
        hash['Kitchen'] = {ratio: 0.011316747261167846, space_type_gen: true, default: false}
        hash['RetailSales'] = {ratio: 0.8218873118856336, space_type_gen: true, default: false}
        hash['Work'] = {ratio: 0.03995629400988969, space_type_gen: true, default: false}
        hash['StockRoom'] = {ratio: 0.09095424891943345, space_type_gen: true, default: false}
        hash['OfficeGeneral'] = {ratio: 0.03588539792387544, space_type_gen: true, default: false}
    elsif building_type == 'RtS'
        hash['StockRoom'] = {ratio: 0.19997764114030184, space_type_gen: true, default: false}
        hash['RetailSales'] = {ratio: 0.8000223588596982, space_type_gen: true, default: false}
    elsif building_type == 'SCn'
        hash['WarehouseCond'] = {ratio: 1.0, space_type_gen: true, default: false}
    elsif building_type == 'SUn'
        hash['WarehouseUnCond'] = {ratio: 1.0, space_type_gen: true, default: false}
    elsif building_type == 'WRf'
        hash['RefStorFreezer'] = {ratio: 0.4005, space_type_gen: true, default: false}
        hash['RefStorCooler'] = {ratio: 0.4995000000000001, space_type_gen: true, default: false}
        hash['OfficeGeneral'] = {ratio: 0.020000000000000007, space_type_gen: true, default: false}
