...
# start the measure
class AddTransformerWithStorage < OpenStudio::Measure::ModelMeasure

  # human readable name
  def name
    return "Add Transformer With Storage"
  end

  # human readable description
  def description
    return "Adds an ELC:Transformer, a ELC:storage-simple and an ELC:distribution objects to the model, requires Schedule named 'Transformer Output Electric Energy Schedule' to exist in the model. This schedule should be in units of Joules."
  end
  ...
  def run(model, runner, user_arguments)
    ...
    distribution.setTransformer(transformer)
...
AddTransformerWithStorage.new.registerWithApplication
