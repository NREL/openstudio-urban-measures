...
class DencityReports < OpenStudio::Ruleset::ReportingUserScript
  ...
  def run(runner, user_arguments)
    ...
    begin
      ...
      runner.registerValue("elevation", elev, "m")
      metadata[metadata.length] = ["elevation", "Elevation", "Elev", "Building elevation based on weather file", "meter", "double", "FALSE"]
      ...
      # Not sure how to get nominal floor to floor height anymore.
      ...
      if get_timeseries_flag
        ...
        if msgpack_flag and csv_flag
          ...
          CSV.open("report_timeseries.csv", "wb") do |csv|
