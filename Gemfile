...
gem 'openstudio-workflow', :git => 'git://github.com/NREL/OpenStudio-workflow-gem.git', :ref => '0902102fbad56383e323484f7cdd5d858bef014c'
#gem 'openstudio-workflow', :path => 'E:/openstudio-workflow-gem'
