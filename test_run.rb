...
buildings = [
   # {name: "Large-Office",             building_type: "Office",                        total_bldg_area_ip: 46320,  num_floors: 12},
   # {name: "Medium-Office",            building_type: "Office",                        total_bldg_area_ip: 4982,   num_floors: 3},
   # {name: "Small-Office",             building_type: "Office",                        total_bldg_area_ip: 511,    num_floors: 1},
   # {name: "Warehouse",                building_type: "Nonrefrigerated warehouse",     total_bldg_area_ip: 4835,   num_floors: 1},
   # {name: "StandaloneRetail",         building_type: "Retail other than mall",        total_bldg_area_ip: 2319,   num_floors: 1},
   # {name: "Strip-Mall",               building_type: "Strip shopping mall",           total_bldg_area_ip: 2090,   num_floors: 1},
   # {name: "Primary-School",           building_type: "Education",                     total_bldg_area_ip: 6871,   num_floors: 1},
   # {name: "Secondary-School",         building_type: "Education",                     total_bldg_area_ip: 19592,  num_floors: 2},
   # {name: "Supermarket",              building_type: "Food sales",                    total_bldg_area_ip: 4180,   num_floors: 1},
   # {name: "Quick-Service-Restaurant", building_type: "Food service",                  total_bldg_area_ip: 232,    num_floors: 1},
   # {name: "Full-Service-Restaurant",  building_type: "Food service",                  total_bldg_area_ip: 511,    num_floors: 1},
   # {name: "Hospital",                 building_type: "Inpatient health care",         total_bldg_area_ip: 22422,  num_floors: 5},
   # {name: "Outpatient-Health-Care",   building_type: "Outpatient health care",        total_bldg_area_ip: 3804,   num_floors: 3},
   # {name: "Small-Hotel",              building_type: "Lodging",                       total_bldg_area_ip: 4013,   num_floors: 4},
   # {name: "Large-Hotel",              building_type: "Lodging",                       total_bldg_area_ip: 11345,  num_floors: 6},
   # {name: "Midrise-Apartment",        building_type: "Multifamily (5 or more units)", total_bldg_area_ip: 3134,   num_floors: 4,  number_of_residential_units: 24},
   # {name: "Single-Family",            building_type: "Single-Family",                 total_bldg_area_ip: 200,    num_floors: 2,  number_of_residential_units: 1},
   # {name: "Multifamily-4",            building_type: "Multifamily (2 to 4 units)",    total_bldg_area_ip: 800,    num_floors: 2,  number_of_residential_units: 4},
   # {name: "Multifamily-8",            building_type: "Multifamily (5 or more units)", total_bldg_area_ip: 1600,   num_floors: 3,  number_of_residential_units: 8},
   # {name: "Mobile-Home",              building_type: "Mobile Home",                   total_bldg_area_ip: 80,     num_floors: 1,  number_of_residential_units: 1},
